        ...
        <div className="relative min-h-[calc(100vh-80px)] md:min-h-screen flex items-center justify-center">
            ...
            <div className="relative z-10 text-center max-w-4xl px-4 animate-fade-in-up py-20">
                ...
                <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 leading-tight tracking-tight">
                    Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-cyan-200">Dindigul Region</span>
                </h1>
            ...
            <div className="max-w-6xl w-full relative z-10">
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 grid sm:grid-cols-2 gap-6 content-center">
                        ...
                        <StatCard icon={<MapPin />} label="Branch Network" value={`${stats.branchCount} Branches`} sub="Across Dindigul Region" />
                                ...
                                {orgData.branches && orgData.branches.map(branch => {
                                    ...
                                    return (
                                        <div key={branch.branch_code} className="relative">
                                            ...
                                            {/* Branch Children (Staff) */}
                                            {isExpanded && (
                                                <div className="mt-4 ml-8 pl-6 border-l-2 border-dashed border-gray-200 animate-fadeIn space-y-3">
                                                    {branch.head && renderStaffCard(branch.head, true)}
                                                    {branch.team.length > 0 ? (
                                                        branch.team.map(member => renderStaffCard(member))
                                                    ) : (
                                                        !branch.head && <p className="text-gray-400 italic text-sm py-2">No staff members assigned.</p>
                                                    )}
                                                </div>
                                            )}
                                        </div>
        ...
        <div className="min-h-screen bg-gray-50 font-sans text-gray-800 flex flex-col">
                ...
                <div className="max-w-7xl mx-auto px-4 h-full flex justify-between items-center">
                    <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigateTo('home')}>
                        ...
                        <span className="text-xl font-bold tracking-tight text-blue-900">
                            IOB Dindigul <span className="opacity-75 font-normal text-sm ml-1 text-gray-500">3933</span>
                        </span>
                    </div>
            ...
            <main className="flex-1 overflow-y-auto overflow-x-hidden">
                ...
                {activeView === 'map' && (
                    <div className="min-h-[calc(100vh-80px)] bg-slate-50 flex flex-col items-center p-4 py-20">
                        <div className="max-w-6xl w-full">
                            <BranchMap branches={orgData.branches} regionName="Dindigul Region" />
                        </div>
                    </div>
                )}
...
export default DindigulLanding;
